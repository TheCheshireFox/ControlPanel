...
//     ];
//     
//     private static readonly Dictionary<int, AgentAudioStream> _testStreams = new()
//     {
...
//     }
//
//     private static void AssertStateEqual(AudioStreamState state, AgentAudioStream stream)
//     {
//         Assert.Multiple(() =>
//         {
...
//     }
//     
//     private static AgentAudioStream CreateStream(string agentId, byte id, bool mute, double volume)
//         => CreateStream(agentId, id, id.ToString(), mute, volume);
//     
//     private static AgentAudioStream CreateStream(string agentId, byte id, string iconName, bool mute, double volume)
